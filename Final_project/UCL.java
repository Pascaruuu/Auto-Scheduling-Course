...
public class UCL {
    ...
    public double getTotalAmount() {
        ...
        while (current != null) {
            // Calculate the amount based on the price of each course
            totalAmount += current.course.getPrice();
            current = current.next;
        }
    ...
    public boolean addCourse(Course course) {
        ...
        while (current != null) {
            if (hasScheduleConflict(course, current.course)) {
                System.out.print("\u001B[31m");
                System.out.println("The course has a schedule conflict with " + current.course + ". You cannot add it.");
                System.out.print("\u001B[0m");
                return false;
            }
            current = current.next;
        ...
        // Display the total amount after adding the course
        double totalAmount = getTotalAmount();
        System.out.println("Total amount after adding " + course.getName() + ": " + totalAmount + " USD");
